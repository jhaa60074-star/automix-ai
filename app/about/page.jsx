  ...
  return (
    <div className="container" style={{ padding: '4rem 1.5rem', maxWidth: '800px' }}>
      <div className="section-header">
        <h1 className="section-title">About Automik</h1>
      ...
      <div className="card" style={{ padding: '3rem', marginBottom: '3rem', borderTop: '4px solid var(--primary-color)' }}>
        ...
        <p style={{ fontSize: '1.125rem', color: 'var(--text-secondary)', lineHeight: '1.8' }}>
          At Automik, we believe that advanced AI and powerful business automations shouldn't be restricted to enterprise companies with large engineering teams. Our mission is to build intuitive, scalable, and premium tools that allow any business owner to leverage AI to save time, engage customers, and analyze data effortlessly.
        </p>
      </div>
      ...
      <div className="card" style={{ padding: '3rem', marginBottom: '3rem' }}>
        ...
        <p style={{ fontSize: '1.125rem', color: 'var(--text-secondary)', lineHeight: '1.8', marginBottom: '1.5rem' }}>
          We envision a future where your software works for you proactively. Instead of managing dozens of disconnected apps, Automik serves as the intelligent central nervous system for your business operations.
        </p>
        <p style={{ fontSize: '1.125rem', color: 'var(--text-secondary)', lineHeight: '1.8' }}>
          Whether it's automatically responding to Instagram comments, summarizing long financial reports, or routing customer queries in WhatsApp, Automik handles the complexity behind a clean, premium interface.
        </p>
      </div>
